<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="ContentManage.aspx.cs" Inherits="Food.Admin.Content.ContentManage" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
 ...
 min-width:190px;
            ...
            <ItemTemplate>
               <tbody>
                <tr onmouseover="this.className='CtrMouseOver tbline'" onmouseout="this.className='CtrMouseOut tbline'" class="CtrMouseOut tbline" id="tr{GZ_infoID}" style="text-align:center; border-bottom:1px solid #ccc">
                   ...
                   <td class="Ctd"><%#Eval("OldName") %></td>
                    <td class="Ctd"><%#Eval("UserName") %></td>
                    <td class="Ctd"><%#Eval("CreateDate") %></td>
               
                    <td class="Ctd"><a href="JavaScript:deletewj(<%#Eval("InfoID") %>)" class="delete" title="删除"  ></a>
                       </td> 
                </tr>
            </tbody>
            </ItemTemplate>
    ...
    <script>
        ...
        {
            $("#<%=HiddenField7.ClientID%>").val(infoid);
