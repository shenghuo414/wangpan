<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="ContactManage.aspx.cs" Inherits="Food.Admin.Content.ContactManage" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
 ...
 min-width:190px;
    ...
    <div id="manage_top" class="menu_top_fixed">
        ...
        <li id="p8" >
            <a href="ContactEidt.aspx" class="new_button_with_new_bg_little " style="padding: 6px 12px; ">批量生成VIP激活码</a></li>
        ...
        <div class="row searchlist" style="border-bottom: 1px solid #ddd; margin-bottom: 10px; padding-bottom: 10px;">
            <asp:Panel ID="pl_select" runat="server" CssClass="form_select col-xs-11">
                ...
                <asp:DropDownList ID="DropDownList1" runat="server" CssClass="drp">
                    ...
                    <asp:ListItem Value="已激活">已激活</asp:ListItem>
            ...
            <ItemTemplate>
               <tbody>
                <tr onmouseover="this.className='CtrMouseOver tbline'" onmouseout="this.className='CtrMouseOut tbline'" class="CtrMouseOut tbline" id="tr{GZ_infoID}" style="text-align:center; border-bottom:1px solid #ccc">
                   ...
                   <td class="Ctd"><%#Eval("Flag") %></td>
                   <td class="Ctd"><%#Eval("ActiveDate") %></td>
                   <td class="Ctd"><%#Eval("UserInfoID") %></td>
